<template>
    <auth-layout>
        ...
        <!-- slot para enviar al AuthLayout: toolbar -->
        <template #toolbar>
            <section>
        ...
        <form @submit.prevent="login" class="flex flex-col">
            ...
            <div class="flex justify-end">
                <inertia-link :href="route('password.request')" class="text-sm text-purple-600 hover:text-purple-700 hover:underline mb-6">
        ...
        <!-- slot para enviar al AuthLayout: footer -->
        <template #footer>
            <p class="text-white">
