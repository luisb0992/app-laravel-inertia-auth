<template>
    <section>
        <div class="h-screen fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            ...
            <!-- array de configuracion con todas las rutas -->
            <nav class="mt-10">
                <inertia-link href="/dashboard" class="flex items-center mt-4 py-2 px-6 border-l-4" :class="[$page.currentRouteName === 'dashboard' ? activeClass : inactiveClass]">
